        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Age = table.Column<int>(type: "int", nullable: false),
                    Phone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ServiceSenterId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_DeliveryPoints_DeliveryPointId",
                        column: x => x.DeliveryPointId,
                        principalTable: "DeliveryPoints",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Employees_ServiceCenters_ServiceCenterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplyGoods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupplyGoods_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupplyGoods_Supplies_SupplyId",
                        column: x => x.SupplyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_DeliveryPointId",
                table: "Employees",
                column: "DeliveryPointId");

            migrationBuilder.CreateIndex(
                name: "IX_Employees_ServiceCenterId",
                table: "Employees",
